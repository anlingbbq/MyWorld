...
namespace LibNoise.Generator
{
    ...
    public class Perlin : ModuleBase
    {
        ...
        /// Initializes a new instance of Perlin.
        /// </summary>
        /// <param name="frequency">The frequency of the first octave.频繁性</param>
        /// <param name="lacunarity">The lacunarity of the perlin noise.空隙度</param>
        /// <param name="persistence">The persistence of the perlin noise.持久性 [环境]</param>
        /// <param name="octaves">The number of octaves of the perlin noise.倍频 八度</param>
